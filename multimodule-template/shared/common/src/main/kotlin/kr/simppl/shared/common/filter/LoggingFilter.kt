package kr.simppl.shared.common.filter
...
class LoggingFilter : OncePerRequestFilter() {
  ...
  protected fun doFilterWrapped(requestWrapper: RequestWrapper, responseWrapper: ResponseWrapper, filterChain: FilterChain) {
    try {
