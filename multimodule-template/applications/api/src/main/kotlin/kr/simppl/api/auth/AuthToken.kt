...
class AuthToken(
  ...
  private fun parseJwt(): Claims? = Jwts.parser()
    .verifyWith(key)
    .build()
    .parseSignedClaims(token)
    .payload

  private fun createAuthToken(userId: Long, expiry: Date): String {
    return Jwts.builder()
  ...
  private fun createAuthToken(userId: Long, expiry: Date, role: String): String {
    return Jwts.builder()
      .subject(userId.toString())
